...
* master - doesn't hide trackers on issues edit/create dialogs and on Project's overview panel.
 To get 'master' branch use: git clone -b master https://github.com/atlascoder/tracker_hider.git

* fix_trackers - hides trackers on issues edit/create dialogs and on Project's overview panel. 'fix_trackers' hides tracker also on issues dialogs and project panel, but due its not pretty patches it was not merged to 'master'. Project overview will show Trackings as for current project, ignoring subproject definitions.
